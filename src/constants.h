...
const QString IS_DEFAUTABLE_KEY("IS_DEFAUTABLE_KEY");
...
const QString PERMANENT_ORGANIZING_SOURCE_KEY("PERMANENT_ORGANIZING_SOURCE_KEY");
...
const int DEFAULT_SUBDIR_SCAN_LIMITED_PASSES=50;
