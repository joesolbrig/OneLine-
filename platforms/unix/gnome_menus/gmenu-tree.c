...
//Yes... this is still the best library for this purpose
//and that's why I'm linking statically to a frozen copy
 ...
 * otherwise when you move a menu X to Y then you may only
 * move one of X, not all the merged Y.
 */
static void
                        ...
                        GMenuTreeDirectory *directory)
{
  ...
  subdirs_sentinel = g_slist_prepend (directory->subdirs, "ONELINE_LIBMENU_FREEZE");
