...
-->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fb="http://www.forwardbias.in">
...
<form style="margin-bottom: 10px" onsubmit="view.setStatus(document.getElementById('status').value); return false;">
    <input type="text" value="What are you doing..." style="width: 450px" id="status" onfocus="this.value=''"/>
